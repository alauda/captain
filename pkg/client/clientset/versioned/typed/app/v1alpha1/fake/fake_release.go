...
var releasesResource = schema.GroupVersionResource{Group: "app.alauda.io", Version: "v1alpha1", Resource: "releases"}

var releasesKind = schema.GroupVersionKind{Group: "app.alauda.io", Version: "v1alpha1", Kind: "Release"}
